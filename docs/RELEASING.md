...
dotnet run --project $smokeProject -c Release --no-build -- --wgc-matrix --matrix-resolutions source,720p,1080p,1440p,2160p --fps 60 --audio --microphone --force-wgc --motion-validation --countdown 5 --artifacts $smokeRoot
```
