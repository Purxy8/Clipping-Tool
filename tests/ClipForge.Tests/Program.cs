...
internal static class Program
{
    ...
    private static async Task<int> Main(string[] args)
    {
        ...
        [
            ...
            ("Desktop Duplication display identity", DesktopDuplicationCaptureTests.DisplayIdentityAsync),
            ("Desktop Duplication capture arguments", DesktopDuplicationCaptureTests.CaptureArgumentsAsync),
            ("Desktop Duplication probe cadence", DesktopDuplicationCaptureTests.ProbeCadenceAsync),
            ("Desktop Duplication recovery policy", DesktopDuplicationCaptureTests.RecoveryPolicyAsync),
            ("Desktop Duplication capability selection", DesktopDuplicationCaptureTests.CapabilitySelectionAsync),
            ("Desktop Duplication focused recovery probe", DesktopDuplicationCaptureTests.FocusedRecoveryAsync),
            ("Desktop Duplication degraded promotion", DesktopDuplicationCaptureTests.PromotionPolicyAsync),
